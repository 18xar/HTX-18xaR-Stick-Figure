...
def DanielP1(x,y,size):
    ...
    arcade.draw_line(x+10*size,y+40*size-10*size-3.75*size,x+10*size,y+40*size-20*size-3.75*size,(255,0,0),bw)
    arcade.draw_line(x+10*size,y+40*size-20*size-3.75*size,x+5*size,y+40*size-20*size-13*size,(255,0,0),bw)
    arcade.draw_line(x+10*size,y+40*size-20*size-3.75*size,x+15*size,y+40*size-20*size-13*size,(255,0,0),bw)
...
def DanielP2(x,y,size):
    ...
    arcade.draw_line(x+10*size,y+40*size-10*size-3.75*size,x+10*size,y+40*size-20*size-3.75*size,color,bw)
    arcade.draw_triangle_filled(x+10*size,y+40*size-20*size-2*size,x+5*size,y+40*size-20*size-9*size,x+15*size,y+40*size-20*size-9*size,color)
    arcade.draw_line(x+7*size,y+40*size-20*size-9*size,x+7*size,y+40*size-20*size-9*size-5*size,color,bw)
    arcade.draw_line(x+13*size,y+40*size-20*size-9*size,x+13*size,y+40*size-20*size-9*size-5*size,color,bw)
